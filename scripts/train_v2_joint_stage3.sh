#!/bin/bash
# TabICLv2 pre-training -- JOINT classifier + regressor (TP-07), Stage 3 (of 3). See
...
CKPT_DIR=/path/to/checkpoints/tabiclv2-joint/stage3
STAGE2_CKPT=/path/to/checkpoints/tabiclv2-joint/stage2/step-40000.ckpt
...
torchrun --standalone --nproc_per_node=$NUM_GPUS -m tabicl.train \
            ...
            --wandb_name tabiclv2_joint_stage3 \
            --device cuda \
            --dtype float32 \
            --np_seed 42 \
            --torch_seed 42 \
